...
BEGIN
	INSERT INTO #ItemDescription(ItemCd, ItemDsc) SELECT  '2000-135-894','8M455VC'
	INSERT INTO #ItemDescription(ItemCd, ItemDsc) SELECT  '2000-136-531','S801GAVAA'
	INSERT INTO #ItemDescription(ItemCd, ItemDsc) SELECT  '2000-137-095','K48M155VC'
	INSERT INTO #ItemDescription(ItemCd, ItemDsc) SELECT  '2000-137-102','K48M155VCB1'
	INSERT INTO #ItemDescription(ItemCd, ItemDsc) SELECT  '2000-137-108','B8M455VC'
	INSERT INTO #ItemDescription(ItemCd, ItemDsc) SELECT  '2000-137-109','S8M455VC'
	INSERT INTO #ItemDescription(ItemCd, ItemDsc) SELECT  '957762',	'VIDEO PRCR MA2155 VF2BGA225 SLM6R COMM >'
END
GO
...
BEGIN
	...
	INSERT INTO #ItemMapping(OldItemCd, NewItemCd, NewItemClassDsc) SELECT  '957762','957762',	'ASIC'
	INSERT INTO #ItemMapping(OldItemCd, NewItemCd, NewItemClassDsc) SELECT  '2000-137-102','2000-137-102','P_TEST'
	INSERT INTO #ItemMapping(OldItemCd, NewItemCd, NewItemClassDsc) SELECT  '2000-137-095','2000-137-095','P_ASSEMBLY'
	INSERT INTO #ItemMapping(OldItemCd, NewItemCd, NewItemClassDsc) SELECT  '2000-137-109','2000-137-109',	'P_SORT'
	INSERT INTO #ItemMapping(OldItemCd, NewItemCd, NewItemClassDsc) SELECT  '2000-137-108','2000-137-108','P_BUMP'
	INSERT INTO #ItemMapping(OldItemCd, NewItemCd, NewItemClassDsc) SELECT  '2000-135-894','2000-135-894','P_FAB'
	INSERT INTO #ItemMapping(OldItemCd, NewItemCd, NewItemClassDsc) SELECT  '2000-136-531','2000-136-531','P_SORT'
	UPDATE tgt
...
BEGIN
	...
	INSERT INTO #BillOfMaterial(ParentItemCd, ParentItemRevision, ChildItemCd, BomAssociationNm, ChildQty) SELECT '957762', '01', '2000-137-102', 'NORMAL', 1		-- CPU -> Test item (normal)
	INSERT INTO #BillOfMaterial(ParentItemCd, ParentItemRevision, ChildItemCd, BomAssociationNm, ChildQty) SELECT '2000-137-102', '01', '2000-137-095', 'NORMAL', 1	-- CPU -> Test item (alternate)
	INSERT INTO #BillOfMaterial(ParentItemCd, ParentItemRevision, ChildItemCd, BomAssociationNm, ChildQty) SELECT '2000-137-095', '01', '2000-137-109', 'NORMAL', 1	-- CPU -> Test item (alternate)
	INSERT INTO #BillOfMaterial(ParentItemCd, ParentItemRevision, ChildItemCd, BomAssociationNm, ChildQty) SELECT '2000-137-109', '01', '2000-137-108', 'NORMAL', 1	-- CPU -> Test item (alternate)
	INSERT INTO #BillOfMaterial(ParentItemCd, ParentItemRevision, ChildItemCd, BomAssociationNm, ChildQty) SELECT '2000-137-108', '01', '2000-135-894', 'NORMAL', 1	-- CPU -> Test item (alternate)
	INSERT INTO #BillOfMaterial(ParentItemCd, ParentItemRevision, ChildItemCd, BomAssociationNm, ChildQty) SELECT '2000-137-095', '01', '2000-136-531', 'NORMAL', 1	-- CPU -> Test item (alternate)
