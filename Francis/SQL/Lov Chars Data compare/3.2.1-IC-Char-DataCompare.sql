...
BEGIN TRY
    ...
    INSERT INTO #Updated (itm_class, expected_att_nme, expected_att_dsc)
          SELECT 'BAGS','BAG-PRINTED-PLAIN','Bag-Printed/Plain'
    UNION SELECT 'BAGS','BAG-MATERIAL-ATTRIBUTES','BAG-MATERIAL-ATTRIBUTES';
    ...
    SELECT 'RIGID_CNTR','PRODUCT_LEVEL_ID_CU','PRODUCT_LEVEL_ID_CU','PRODUCT LEVEL IDENTIFICATION CU'
    ...
    UNION SELECT 'BAGS','MM_SHIP_MED','MM_SHIP_MED','Shipment Media'
    UNION SELECT 'BAGS','BAG_ASSY_TYPE','BAG_ASSY_TYPE','Bag Assembly Type'
    UNION SELECT 'BAGS','BAG_CLOSURE','BAG_CLOSURE','Bag Closure'
    UNION SELECT 'BAGS','BAG_MATERIAL','BAG_MATERIAL','Bag Material'
    UNION SELECT 'BAGS','BAG_PRINTED_PLAIN','BAG_PRINTED_PLAIN','Bag Printed/Plain'
    UNION SELECT 'BAGS','BAG_SIZE','BAG_SIZE','Bag Size'
    UNION SELECT 'BAGS','BAG_TYPE','BAG_TYPE','Bag Type'
    UNION SELECT 'BAGS','BAG_MATERIAL_GAUGE','BAG_MATERIAL_GAUGE','Bag Material Gauge'
    UNION SELECT 'BAGS','BAG_MATERIAL_ATTRIBUTES','BAG_MATERIAL_ATTRIBUTES','Bag Material Attributes'
    UNION SELECT 'CFB_CNTR','MM_SHIP_MED','MM_SHIP_MED','Shipment Media'
    UNION SELECT 'FOLDING_CARTON','ADDL_INFO','ADDL_INFO','ADDITIONAL INFO'
    UNION SELECT 'PACKAGING-MATL-KIT','PROJECT_ID','PROJECT_ID','Project Id'
    UNION SELECT 'PALLET','OEM_PN','OEM_PN','OEM Part Number'
    UNION SELECT 'PALLET','PALLET_ADDL_INFO','PALLET_ADDL_INFO','Additional Info'
    UNION SELECT 'PALLET','PALLET_BUILD','PALLET_BUILD','Pallet Build'
    UNION SELECT 'PALLET','PALLET_FACING','PALLET_FACING','Pallet Facing'
    UNION SELECT 'PALLET','PALLET_MATERIAL','PALLET_MATERIAL','Pallet Material'
    UNION SELECT 'PALLET','PALLET_SIZE','PALLET_SIZE','Pallet Size'
    UNION SELECT 'RIGID_CNTR','ADDL_INFO','ADDL_INFO','ADDITIONAL INFO'
    UNION SELECT 'SILICON_WAFER','ADDL_INFO','ADDL_INFO','ADDITIONAL INFO'
    UNION SELECT 'SILICON_WAFER','SUPPLIER_IDENTIFICATION_CODE','SUPPLIER_IDENTIFICATION_CODE','Code for Supplier ID'
    UNION SELECT 'SILICON_WAFER','ENGINEERING_PRODUCT_INDICATOR','ENGINEERING_PRODUCT_INDICATOR','Engineering Product Indicator'
    UNION SELECT 'SILICON_WAFER','WAFER_SPECIAL_IDENTIFICATION_CODE','WAFER_SPECIAL_IDENTIFICATION_CODE','Special ID Code'
    UNION SELECT 'SILICON_WAFER','WAFER_CONDUCTIVITY_TYPE_IDENTIFIER','WAFER_CONDUCTIVITY_TYPE_IDENTIFIER','WFR CONDUCTIVITY IDENTIFIER'
    UNION SELECT 'SILICON_WAFER','ADDITIONAL_INFORMATION_2','ADDITIONAL_INFORMATION_2','ADDITIONAL INFO'
    UNION SELECT 'SILICON_WAFER','NECESSARY_CONFLICT_MINERAL_NAME','NECESSARY_CONFLICT_MINERAL_NAME','NECESSARY CONFLICT MINERAL NM';
