...
-- Drop working tables
drop table if exists #dm_bom_99CDJZ
drop table if exists #dm_items_99CDJZ

-- Drop core temporary tables
drop table if exists #item_type
drop table if exists #item
drop table if exists #item_revision
drop table if exists #item_plant
drop table if exists #uda_item

-- Drop BOM and reference tables
drop table if exists #design_bom
drop table if exists #sap_mat_item_bank
drop table if exists #codes_and_values
drop table if exists #IBC_class_mapping
...
begin 
	...
	join (select distinct as_is_item_typ_dsc, to_be_item_typ_dsc 
	      from workdb.dbo.IBC_class_mapping 
	...
	begin
		...
		left join workdb.dbo.IBC_class_mapping m on m.as_is_item_typ_dsc = it.item_typ_dsc and ui.att_idn = m.att_idn
...
SELECT *
      from #dm_bom_99CDJZ
      where parent_item_cde = '99CDJZ' and parent_item_rev = '08'
